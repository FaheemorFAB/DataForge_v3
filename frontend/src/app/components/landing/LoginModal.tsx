...
<div className="flex flex-col gap-2 w-full">
  <a href={`${process.env.NEXT_PUBLIC_API_BASE_URL ?? "http://localhost:8000"}/login/google`} className="google-btn">
  ...
  {process.env.NODE_ENV === "development" && (
    <a href={`${process.env.NEXT_PUBLIC_API_BASE_URL ?? "http://localhost:8000"}/login/mock`} className="google-btn" style={{ background: "rgba(255,255,255,0.05)", color: "#fff", border: "1px solid rgba(255,255,255,0.1)", marginTop: "0.25rem" }}>
