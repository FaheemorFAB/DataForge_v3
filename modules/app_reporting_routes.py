...
Also add to app.py imports section:
    ...
    from modules.scheduler         import init_scheduler, add_report_job, remove_report_job, list_jobs
...
def api_schedules_create():
    ...
    try:
        from modules.scheduler import _register_job
...
def api_schedules_delete(schedule_id: int):
    from modules.scheduler import remove_report_job
