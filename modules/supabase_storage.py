...
Usage
─────
    from modules.supabase_storage import SupabaseStorage, STORAGE_OK
...
_LOCAL_FALLBACK_DIR = Path(__file__).parent.parent / "instance" / "projects"
